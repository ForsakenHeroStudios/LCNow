...
//                PendingIntent pendingIntent = PendingIntent.getActivity(context,requestID,notificationIntent,PendingIntent.FLAG_UPDATE_CURRENT);
                ...
                Toast.makeText(context,events.get(position).getTitle()+" "+events.get(position).getTime(),Toast.LENGTH_SHORT).show();
                ...
                calendar.set(Integer.parseInt(time.substring(0,4)),Integer.parseInt(time.substring(5, 7)),Integer.parseInt(time.substring(8, 10)),Integer.parseInt(time.substring(11, 13))-1,Integer.parseInt(time.substring(14, 16)),Integer.parseInt(time.substring(17, 19)));
